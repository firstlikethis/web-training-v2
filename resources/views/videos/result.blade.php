...
<div class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 flex justify-between">
            ...
            <a href="{{ route('courses.show', $video->course->slug) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                กลับไปหน้าคอร์ส
            </a>
        </div>
    </div>
